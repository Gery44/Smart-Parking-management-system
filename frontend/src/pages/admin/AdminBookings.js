...
const AdminBookings = () => {
  ...
  const filteredBookings = bookings.filter((booking) => {
    ...
    return (
      ...
      booking.slotId.toLowerCase().includes(term) ||
      booking.status.toLowerCase().includes(term) ||
      booking.startTime.toLowerCase().includes(term) ||
      booking.endTime.toLowerCase().includes(term) ||
      booking.bookingAmount.toString().includes(term) ||
      booking.totalAmount.toString().includes(term) ||
      (booking.penaltyAmount && booking.penaltyAmount.toString().includes(term))
    );
  });
