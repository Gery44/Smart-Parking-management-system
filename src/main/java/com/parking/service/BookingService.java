...
public class BookingService {
    ...
    // public Booking createBooking(Booking booking) {
    //     // Parse LocalDateTime from the frontend input
    ...
    //     double bookingAmount = hours * parkingSlot.getHourlyRate();
    //     booking.setBookingAmount(bookingAmount);
    //     booking.setTotalAmount(bookingAmount); // Initially total amount is the same as booking amount
    
    //     // Book the parking slot
    //     parkingSlotService.bookParkingSlot(booking.getSlotId(), booking.getUserId(), startTime, endTime);
    ...
    public Booking createBooking(Booking booking) {
        ...
        // Book the parking slot
        parkingSlotService.bookParkingSlot(booking.getSlotId(), booking.getUserId(), formattedStartTime, formattedEndTime);
